"""Example of a module that defines the content/assets/resources used by the code
...
WELCOME_MSG = 'Welcome to "Echoes of Destiny"'

GAME_INTRO = "In a world where shadows whisper secrets and ancient powers lie dormant,\
 two unlikely heroes will embark on a journey that will test their courage, wit, and friendship."

GAME_SETTING = "Nestled between the towering peaks of the Eldrath Mountains and the sprawling Whispering Woods,\
